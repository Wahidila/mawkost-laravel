...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $k1 = Kost::create([
            ...
            'unlock_price' => 15000, 'address' => 'Jl. Soekarno Hatta Indah No. XX, Lowokwaru, Malang',
        ...
        $k6->facilities()->attach([$facilities['Lemari Pakaian']->id, $facilities['Kasur Springbed']->id, $facilities['Meja Belajar']->id]);
    }
}
