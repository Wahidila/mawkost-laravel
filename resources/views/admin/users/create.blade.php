...
<div class="bg-white w-full shadow rounded-lg p-6 max-w-2xl">
    <div class="flex justify-between items-center border-b pb-4 mb-4">
        <h3 class="text-lg font-semibold text-gray-800">Form Pengguna Baru</h3>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="08123456789">
        </div>
        ...
        <div class="mb-6 border-t pt-4">
            ...
            <input type="password" name="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" minlength="8" required>
