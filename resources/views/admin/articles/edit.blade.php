        ...
        <div class="p-6 space-y-5">
            ...
            <div>
                ...
                @if($article->published_at)
                    <p class="text-xs text-gray-400 mt-1"><i class="fas fa-clock mr-1"></i> Dipublish {{ $article->published_at->format('d M Y, H:i') }}</p>
                @endif
            </div>
        </div>
...
<style>
    ...
    .ck-editor__editable h2 { font-family: 'Poppins', sans-serif; font-size: 1.5rem; font-weight: 700; color: #5C3D2E; margin: 24px 0 12px; }
